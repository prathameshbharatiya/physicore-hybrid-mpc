    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-full">
      <div className="bg-slate-900/40 p-4 rounded-sm border border-white/5 flex flex-col">
        ...
        <div className="mt-2 flex justify-between items-baseline">
          ...
          <span className="text-[8px] text-indigo-400 font-mono">ERROR_GRADIENT</span>
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center">
           <div className="relative w-28 h-28">
             ...
             <div className="absolute inset-0 flex items-center justify-center flex-col">
               ...
               <span className="text-[8px] text-slate-600 uppercase tracking-tighter">Confidence Score</span>
             </div>
           </div>
        </div>
        <div className="mt-4 border-t border-white/5 pt-2 grid grid-cols-2 gap-2">
           <div className="text-[9px] text-slate-500 uppercase">Solver: <span className="text-emerald-500 font-bold">RK4_HIFI</span></div>
           <div className="text-[9px] text-slate-500 uppercase">J_Loss: <span className="text-emerald-500 font-bold">{(Math.random() * 0.1).toFixed(4)}</span></div>
        </div>
      </div>
      ...
      <div className="bg-slate-900/40 p-4 rounded-sm border border-white/5 flex flex-col">
        ...
        <div className="space-y-2.5 mt-2 flex-1 overflow-y-auto custom-scroll">
          ...
          <div className="flex justify-between items-center text-[10px]">
            <span className="text-slate-500">Manifold Tracking</span>
            <span className="text-pink-400 font-bold">Verlet Mesh</span>
          </div>
          <div className="flex justify-between items-center text-[10px]">
            <span className="text-slate-500">Edge Client</span>
            <span className="text-cyan-400 font-bold">ONNX Runtime</span>
          </div>
          <div className="flex justify-between items-center text-[10px]">
            <span className="text-slate-500">Uplink</span>
            <span className="text-white font-mono">gRPC-Stream</span>
          </div>
          <div className="pt-2 mt-auto border-t border-white/5">
            <div className="flex justify-between text-[8px] mb-1 text-slate-400 uppercase font-bold tracking-widest">Weights Memory</div>
            <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
              <div className="bg-indigo-600 h-full w-[42%] shadow-[0_0_8px_#4f46e5]"></div>
            </div>
          </div>
        </div>
      </div>
